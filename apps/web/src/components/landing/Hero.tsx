  ...
  return (
    <div className="mx-auto grid max-w-[1200px] items-center gap-14 px-6 pb-10 pt-14 md:grid-cols-[1.05fr_.95fr] md:px-10 md:pt-[76px]">
      ...
      <div className="relative flex justify-center">
        <div className="pointer-events-none absolute left-1/2 top-1/2 size-[380px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-[radial-gradient(circle,var(--ob-accent-soft),transparent_70%)]" />
